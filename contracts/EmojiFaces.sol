// SPDX-License-Identifier: MIT
    ...
    contract CryptoBears is ERC721, Ownable, ERC721Enumerable {
      ...
      event BearsMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("CryptoBears", "CB") {}
      ...
      function mintBears(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit BearsMinted(id, msg.sender);
          }
        }
      }
    
      function presaleBears(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmQNtaqg4uPzap57g2vzY46UjYgwHPH3C4z89bkGw91NKn/hidden.json";
        }
